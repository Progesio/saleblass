...
<head>
    ...
    <title>Progesio Whatsapp Blass</title>

    <meta name="description" content="Progesio Whatsapp Blass">
    <meta name="keywords" content="Progesio, Whatsapp Blass, Progesio Whatsapp Blass">
    <meta name="author" content="Progesio">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="author" content="Progesio">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    {{-- icon --}}
    <link rel="icon" href="https://progesio.my.id/icon.png" type="image/x-icon">
